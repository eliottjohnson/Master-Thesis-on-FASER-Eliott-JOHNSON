...
\centering    
    ...
    \draw (3,1.5) parabola (11.5,1.7);
    \draw (3,1.5) parabola (11.5,1.3);
    \node at (-0.5,1.7) {A'};
    \node at (11.75,1.75) {e+};
    \node at (11.75,1.3) {e-};
    \draw[fill=red, fill opacity=0.8, rotate around={5:(13,2.5)}] (12.95,1.8) ellipse (1cm and 0.3cm);
    \draw[fill=red, fill opacity=0.8, rotate around={-5:(13,0.5)}] (12.95,1.2) ellipse (1cm and 0.3cm);
    \end{tikzpicture}    
\caption{Signal signature $A'\rightarrow e^{+}e^{-}$.}
\label{fig:SignalSignature}
\end{figure}

The long-lived particles that will travel and enter the 20 cm width of FASER will be highly energetic of the order of the TeV \cite{faser_collaboration_faser_2019}. If we use that $p_{T}\sim m$:
